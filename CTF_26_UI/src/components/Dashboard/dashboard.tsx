...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Green color space transformation
    float intensity = (r_val + g_val + b_val) / 3.0;
    
    fragColor = vec4(
        intensity * 0.3,           // Red channel (dim)
        intensity * 1.2,           // Green channel (bright)
        intensity * 0.4,           // Blue channel (dim)
        1.0
    );
}
