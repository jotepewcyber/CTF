          ...
          >
            ...
            <div className="px-8 pb-8">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16 mb-8">
                {/* Avatar */}
                <div className="w-32 h-32 rounded-full bg-linear-to-r from-emerald-500 to-teal-500 flex items-center justify-center border-4 border-black shadow-lg shrink-0">
                  {user.avatar_url ? (
                    <img
                      src={user.avatar_url}
                      alt={user.username}
